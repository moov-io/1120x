...
We recommend using additional git remote's for pushing/pulling code. Go cares about where the `1120x` project lives relative to `GOPATH`.

First, pull down our source code:

```
$ git clone git@github.com:moov-io/1120x.git
```

Then, add your (or another user's) fork.

```
$ cd $GOPATH/src/github.com/moov-io/1120x

$ git remote add $user git@github.com:$user/1120x.git
...
Our Build pipeline utilizes [Github Actions](https://github.com/moov-io/1120x/actions) to enforce many tools that you should add to your editor before issuing a pull request. Learn more about these tools on our [Go Report card](https://goreportcard.com/report/github.com/moov-io/1120x)
